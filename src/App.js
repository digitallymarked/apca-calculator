    ...
    >
      ...
      <div className='p-8 container mx-auto md:w-auto md:px-32  bg-white/80 rounded-3xl border border-gray-300 shadow-2xl flex flex-col gap-8 items-center '>
        <button
          ...
          className='container md:w-72 p-4 rounded-xl shadow-md font-bold flex justify-center gap-2'
        >
          <Icon fill={textColor} />
          Auto tint button
        </button>
        <span>
          ...
          <a
            ...
            className='underline underline-offset-2 text-blue-500 hover:text-blue-600 font-semibold'
            target='_blank'
            rel='noreferrer'
          >
            APCA algorithm ↗
