...
export default function App() {
  ...
  let adjustedColor = Color(textColor).alpha(0.8)
  ...
  return (
    ...
    >
      ...
      <div className='p-8 container mx-auto md:w-auto md:px-32  bg-white/80 rounded-3xl border border-gray-300 shadow-2xl flex flex-col gap-8 items-center text-gray-900'>
        <button
          style={{
            background: hex,
            color: adjustedColor,
